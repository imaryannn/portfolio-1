  ...
  return (
    <footer style={{ position: "relative", padding: "48px 0" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "24px", marginLeft: "160px" }}>
          {[
            ...
            <a
              ...
              onMouseLeave={e => e.currentTarget.style.color = "rgba(248,245,238,0.55)"}
            >
              {icon}
              {label}
            </a>
          ))}
          <span style={{ color: "rgba(248,245,238,0.25)", fontSize: "14px" }}>/</span>
          <a
        ...
        <p style={{ fontSize: "13px", color: "rgba(248,245,238,0.35)" }}>
